  ...
  return `
    <section class="hero-grid">
      ...
      <form class="panel" id="registerForm">
        <h2>Register</h2>
        <p class="small muted">Company emails ending with @${company.domain} are auto-approved.</p>
        <div class="field">
  ...
  return `
    ...
    <section class="dashboard-grid">
      ...
      <article class="panel">
        ...
        <div class="notice">${company.name} uses @${company.domain}. Current customer limit: ${company.accountLimit} users.</div>
        <div class="field">
